 ...
 *  Changelog:
 *
 *  0.10 (03/14/2021) -    Initial 0.1 Beta.
 *
 *
 *   Button Mappings:
 *
...
metadata {
    definition (name: "GE/Jasco Z-Wave Plus Dimmer Switch", namespace: "kounoupis", author: "Marios Hadjieleftheriou") {
        capability "Actuator"
        capability "Button"
...
def parse(String description) {
    ...
    def result = null
    def cmd = zwave.parse(description, [0x20: 1, 0x25: 1, 0x26: 3, 0x56: 1, 0x70: 2, 0x72: 2, 0x85: 2, 0x5B: 1])
    if (cmd) {
    ...
    if (!device.currentValue("supportedButtonValues")) {
        createEvent(name: "supportedButtonValues", value:JsonOutput.toJson(["pushed"]), displayed:false)
    }
    result    
}
